...
namespace ClothingForDocuSign.UnitTests
{
	...
	public class ClothingModelTests
	{
		...
		public void Can_Run()
		{
			...
			var clothingRulesMock = new Mock<IClothingRules>();
			clothingRulesMock.Setup(m => m.Rules.Next(It.IsAny<IClothingCommand>())).Returns(true);
		...
		public void Can_Restart()
		{
			...
			var clothingCommandRepositoryMock = new Mock<IClothingCommandRepository>();
			var clothingRulesMock = new Mock<IClothingRules>();
			clothingRulesMock.Setup(m => m.Rules.StartOver());
			...
			// Assert
			clothingRulesMock.Verify(x => x.Rules.StartOver(), Times.Once());
		}
		...
		public void Can_Run_Send_Fail_When_No_This_Id()
		{
			// Arrange - IClothingRules
			var clothingRulesMock = new Mock<IClothingRules>();
			clothingRulesMock.Setup(m => m.Rules.Next(It.IsAny<IClothingCommand>())).Throws(new ArgumentOutOfRangeException());
