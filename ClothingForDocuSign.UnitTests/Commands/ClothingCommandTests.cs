...
namespace ClothingForDocuSign.UnitTests.Commands
{
	...
	public class ClothingCommandTests
	{
		...
		public void Can_Response()
		{
			...
			// Act
			var hotResponse1 = clothingCommand1.Response(TemperatureType.HOT);
			var coldResponse1 = clothingCommand1.Response(TemperatureType.COLD);

			var hotResponse2 = clothingCommand2.Response(TemperatureType.HOT);
			var coldResponse2 = clothingCommand2.Response(TemperatureType.COLD);
