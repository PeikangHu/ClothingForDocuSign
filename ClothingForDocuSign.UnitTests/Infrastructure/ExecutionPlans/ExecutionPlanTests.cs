...
namespace ClothingForDocuSign.UnitTests.Infrastructure.ExecutionPlans
{
	...
	public class ExecutionPlanTests
	{
		...
		public void Can_Run_All_Right()
		{
			...
			// Act
			var step1Result = executionPlan.Next(1);
			var step2Result = executionPlan.Next(2);
			var step3Result = executionPlan.Next(3);
		...
		public void Can_Run_Wrong_Sequence()
		{
			...
			// Act
			var step1Result = executionPlan.Next(2);
			var step2Result = executionPlan.Next(1);
			var step3Result = executionPlan.Next(4);
			var step4Result = executionPlan.Next(1);
			var step5Result = executionPlan.Next(1);
