...
namespace ClothingForDocuSign.Views
{
	public class ClothingConsoleView : IClothingConsoleView
	{
		...
		private TemperatureType _tempratureType;
		...
		private void OnInputFinished(TemperatureType? tempratureType, IList<int> commandIds, bool exit = false)
		{
		...
		private TemperatureType GetTempratureType(string input)
		{
			if (input == null || input == "") throw new ArgumentNullException("Input should not be NULL.");
